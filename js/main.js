;(function() {
  ...
  var dayMilestones = [
    ...
    ["Lunch",12], 
    ["Sunset", 8+12], 
    ["Get ready for bed", 12+10], 
    ["Bed time", 12+10.00001]
  ];
  ...
  var loadAPICall = function(force) {
    var apiKey = "82fb771b32a64dd266663d84d72bd0d6";

    if (!localStorage.getItem("weatherData") || force) {
      $.ajax({
        url: "https://api.forecast.io/forecast/" + apiKey + "/40.715121, -74.015648",
        dataType: "jsonp",
        success: function (data) {
          weatherData = window.data = data;
      ...
      weatherData = window.data = JSON.parse(localStorage.getItem("weatherData"));
